...
public class PromptConfig {
    ...
    // ===========================================
    // LLM INTELLIGENT GRADING SYSTEM
    // ===========================================
     ...
     * 构建完整的评分提示词
     */
    public static String buildGradingPrompt(String subject, String grade, String studentName,
                                          String questionsAndAnswers, int questionCount) {
        return MAIN_GRADING_PROMPT
                .replace("{subject}", subject != null ? subject : "")
                .replace("{grade}", grade != null ? grade : "")
                .replace("{studentName}", studentName != null ? studentName : "学生")
     ...
     * 构建单个题目的评分内容
     */
    public static String buildQuestionGradingContent(int questionNumber, String questionType,
                                                   int fullMarks, String questionContent,
                                                   String standardAnswer, String studentAnswer) {
        return QUESTION_GRADING_TEMPLATE
                .replace("{questionNumber}", String.valueOf(questionNumber))
                .replace("{questionType}", questionType)
                .replace("{fullMarks}", String.valueOf(fullMarks))
                .replace("{questionContent}", questionContent)
                .replace("{standardAnswer}", standardAnswer != null ? standardAnswer : "")
     ...
     * 构建快速简答题评分提示词
     */
    public static String buildQuickGradingPrompt(String questionContent, String standardAnswer, 
                                               String studentAnswer, int fullMarks) {
        return QUICK_SHORT_ANSWER_GRADING_PROMPT
                .replace("{questionContent}", questionContent)
                .replace("{standardAnswer}", standardAnswer != null ? standardAnswer : "")
                .replace("{studentAnswer}", studentAnswer != null ? studentAnswer : "")
                .replace("{fullMarks}", String.valueOf(fullMarks));
